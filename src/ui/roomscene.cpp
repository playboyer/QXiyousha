...
void RoomScene::changeHp(const QString &who, int delta, DamageStruct::Nature nature){
    ...
    if(delta < 0){
        ...
        if(nature == DamageStruct::Fire)
            ...
            doAnimation("water", QStringList() << who);
...
void RoomScene::doAnimation(const QString &name, const QStringList &args){
    ...
    if(map.isEmpty()){
        ...
        map["water"] = &RoomScene::doAppearingAnimation;
        map["typhoon"] = &RoomScene::doAppearingAnimation;

        map["wind-slash"] = &RoomScene::doAppearingAnimation;
        map["water-slash"] = &RoomScene::doAppearingAnimation;
        map["fire-slash"] = &RoomScene::doAppearingAnimation;
        map["jink"] = &RoomScene::doAppearingAnimation;
        map["wuxingshan"] = &RoomScene::doAppearingAnimation;
        map["jinguzhou"] = &RoomScene::doAppearingAnimation;
        map["shengsibu"] = &RoomScene::doAppearingAnimation;
        map["shengsi"] = &RoomScene::doMovingAnimation;
